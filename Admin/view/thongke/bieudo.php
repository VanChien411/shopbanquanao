  ...
  <script type="text/javascript" src="https://www.google.com/jsapi"></script>
    <!-- <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {'title':'Bản danh sách thống kê sản phẩm theo danh mục',
                       'width':500,
                       'height':300};
...
function drawChart() {
    ...
    <?php
            ...
            foreach ($listThongKe as $rows) {
              extract($rows);
                ...
                echo "['".$rows['tenDM']."', ".$rows['countsp']."]$dauphay";
                $i += 1;
            }
          ?>
  ...
  var options = {'title':'Thống kê danh mục', 'width':550, 'height':400};
