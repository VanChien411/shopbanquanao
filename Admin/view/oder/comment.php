                            ...
                            foreach($result as $rows){
                              echo '
                                <tr class="tr">
                                    ...
                                    <td class="th">'.$rows['maBL'].'</td>
                                    <td class="th">'.$rows['noiDung'].'</td>
                                    <td class="th">'.$rows['maSP'].'</td>
                                    <td class="th">'.$rows['maKH'].'</td>
                                    <td class="th"v>'.$rows['ngayBL'].' </td>
                                    <td class="th"><a href="index.php?ctrl=view&action=deleteBL&maBL='.$rows['maBL'].'">Delete</a><td>
