                            ...
                            foreach($result as $rows){
                              echo '
                                <tr class="tr">
                                    ...
                                    <td class="th">'.$rows['maKH'].'</td>
                                    <td class="th">'.$rows['tenDN'].'</td>
                                    <td class="th">'.$rows['matKhau'].'</td>
                                    <td class="th">'.$rows['tenKH'].'</td>
                                    <td class="th">'.$rows['email'].'</td>
                                    <td class="th">'.$rows['diaChi'].'</td>
                                    <td class="th">'.($rows['vaiTro'] == 0 ? 'Khách hàng' : ($rows['vaiTro'] == 1 ? 'Admin' : 'Quan lý')).'</td>

                                    <td class="th">
                                      <a href="index.php?ctrl=view&action=deleteKH&maKH='.$rows['maKH']. '">Delete</a>|
                                      <a href="index.php?ctrl=view&action=editKH&maKH='.$rows['maKH'].'">Edit</a>
                                    </td>
